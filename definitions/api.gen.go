...
func (c *Client) SearchDefinitionsProductTypes(ctx context.Context, params *SearchDefinitionsProductTypesParams) (*http.Response, error) {
	req, err := NewSearchDefinitionsProductTypesRequest(c.Endpoint, params)
	if err != nil {
		return nil, err
	}
...
func (c *Client) GetDefinitionsProductType(ctx context.Context, productType string, params *GetDefinitionsProductTypeParams) (*http.Response, error) {
	req, err := NewGetDefinitionsProductTypeRequest(c.Endpoint, productType, params)
	if err != nil {
		return nil, err
	}
...
func NewSearchDefinitionsProductTypesRequest(endpoint string, params *SearchDefinitionsProductTypesParams) (*http.Request, error) {
	var err error
	...
	basePath := fmt.Sprintf("/definitions/2020-09-01/productTypes")
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
...
func NewGetDefinitionsProductTypeRequest(endpoint string, productType string, params *GetDefinitionsProductTypeParams) (*http.Request, error) {
	var err error

	var pathParam0 string

	pathParam0, err = runtime.StyleParam("simple", false, "productType", productType)
	if err != nil {
		return nil, err
	}
	...
	basePath := fmt.Sprintf("/definitions/2020-09-01/productTypes/%s", pathParam0)
	if basePath[0] == '/' {
		basePath = basePath[1:]
	}
	...
	if params.ProductTypeVersion != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", true, "productTypeVersion", *params.ProductTypeVersion); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.Requirements != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", true, "requirements", *params.Requirements); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
	...
	if params.RequirementsEnforced != nil {
		...
		if queryFrag, err := runtime.StyleParam("form", true, "requirementsEnforced", *params.RequirementsEnforced); err != nil {
			return nil, err
		} else if parsed, err := url.ParseQuery(queryFrag); err != nil {
			return nil, err
		} else {
